...
256/512/1024 三档（YAML 显式配置，默认 256），决定 variable 侧端口覆盖率。启动校验与 fd 自举、禁降档的理由见 [04-客户端.md](04-客户端.md) 第 9 节；创建是全有或全无（`CreateHelpers`）。
